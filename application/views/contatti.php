	<!-- header -->
    <section class="content section-parallax parallax-slider" style="background-image: url('<?php echo site_url('assets/img/banner/contatti.jpg') ?>');">
    	...
    	<div class="container">
        	<div class="row">
            	<div class="col-sm-8 col-sm-offset-2">
                    <p>testo da accompagnare al modulo (con riferimento al gadget)</p>
                    <form>
