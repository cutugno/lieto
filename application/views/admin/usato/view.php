...
<div class="container pagecontainer">
	...
	<div class="row">
		<div class="form-group col-sm-6">
			...
			<?php 
				$attr=array('class'=>'form-control', 'name'=>'og_title[it]', 'value'=>$usato->seo->og_title->it);
				echo form_input($attr);
			?>	
		</div>
		<div class="form-group col-sm-6">
			...
			<?php 
				$attr=array('class'=>'form-control', 'name'=>'og_title[en]', 'value'=>$usato->seo->og_title->en);
				echo form_input($attr);
			?>	
		</div>
	</div>
	<div class="row greyrow">
		<div class="form-group col-sm-6">
			...
			<?php 
				$attr=array('class'=>'form-control', 'name'=>'og_description[it]', 'value'=>$usato->seo->og_description->it);
				echo form_input($attr);
			?>	
		</div>
		<div class="form-group col-sm-6">
			...
			<?php 
				$attr=array('class'=>'form-control', 'name'=>'og_description[en]', 'value'=>$usato->seo->og_description->en);
				echo form_input($attr);
			?>	
		</div>
	</div>
