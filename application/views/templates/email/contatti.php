...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="width: 100% !important;min-width: 100%;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100% !important;margin: 0;padding: 0;background-color: #FFFFFF">
		<p>Hai ricevuto una richiesta gadget. Di seguito i dettagli:</p>
		<table>
			<tr>
			...
			<tr>
				<th style="text-align:right;vertical-align:top">Interessato a:</th>
				<td>
					<table>
						<?php if (isset($interessato)) : ?>
						<?php foreach ($interessato as $val) : ?>
