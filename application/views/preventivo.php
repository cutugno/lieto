	<!-- header -->
    <section class="content section-parallax parallax-slider" style="background-image: url(<?php echo base_url(); ?>assets/img/banner/contatti.jpg);">
    	...
    	<div class="container">
        	<div class="row">
            	<div class="col-sm-offset-3 col-md-offset-3 col-sm-6">
					<p>testo da accompagnare al modulo</p>
                    <form action="/">
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" placeholder="Appartment, suite, unit *">
                        </div>
                        <div class="form-group">
